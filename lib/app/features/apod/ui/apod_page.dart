...
class ApodPage extends StatelessWidget {
  const ApodPage({super.key, this.pictureOfDay});
  ...
  Widget build(BuildContext context) {
    ...
    final PictureOfDayEntity picture = pictureOfDay ??
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            PictureOfDayMediaWidget(pictureOfDayEntity: picture),
            PictureOfDayTitleWidget(pictureOfDayEntity: picture),
            PictureOfDayExplanationWidget(pictureOfDayEntity: picture),
          ],
        ),
      ),
    );
